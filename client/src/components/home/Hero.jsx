...
const slides = [
  {
    eyebrow: 'Back To School Sale',
    title: 'Gear up for a brilliant new term',
    subtitle: 'Up to 40% off notebooks, pens & combo kits.',
    cta: 'Shop Now',
  ...
  {
    eyebrow: 'Birthday Gift Collection',
    title: 'Make every celebration unforgettable',
    subtitle: 'Curated hampers and personalized gifts they will love.',
  ...
  },
  {
    ...
    title: 'Add a personal touch with your photo',
    subtitle: 'Upload a photo, we craft a one-of-a-kind keepsake.',
    cta: 'Customize Now',
    to: '/category/personalized-gifts',
